...
output_dir = "s3://crawlerbucketzz/data/"
glueContext.write_dynamic_frame.from_options(frame = dynamic_frame, connection_type = "s3", connection_options = {"path": output_dir}, format = "csv")
job.commit()
